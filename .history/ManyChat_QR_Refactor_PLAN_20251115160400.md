...
- [ ] Capture base URL in the UI to render accurate example endpoints.
- [ ] Build a combined "Generate & Validate" instruction card with two subsections:
...
- [ ] Move mapping/advanced config guidance into a dedicated secondary card.
